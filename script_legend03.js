...
function calculateWinningParties(features) {
    ...
    var defaultParties = ["PSOE", "PP", "PODEMOS", "COMPROMÍS", "VOX", "ERC", "MÁS MADRID"]; // ajusta según tus necesidades
...
function updateLegend(winningParties) {
    ...
    if (!existingSvg.empty()) {
        ...
        // Si ya existe un elemento SVG, elige qué hacer
        // Opción 1: No crear un nuevo elemento SVG
        // return;
        // Opción 2: Eliminar el elemento SVG existente antes de crear uno nuevo
        existingSvg.remove();
    } else {
